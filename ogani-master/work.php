				...
				<div class="colorlib-narrow-content">
					<div class="col">
						<div class="col-md-12 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							...
							<h4><a href="work.php" class="colorlib-heading">已出借書籍</a>&nbsp;&nbsp;|&nbsp;&nbsp;
							...
							<div class="table-responsive table-responsive-data2">
								<table class="table table-data2">
									...
									<tbody>
										...
										$sql = "select trade.trade_bookname,trade.trade_date,trade.trade_lend,trade.trade_borrow,trade.trade_level,trade.trade_id from trade join authority on trade.trade_lend=authority.name ";
										...
										while ($record = mysqli_fetch_row($rs)) {
											...
											if ($record[4] == 'lend') {
												if ($_SESSION['name'] == $record[2]) {
										?>
													<tr class="tr-shadow">
														<td>
															<span class="status--denied">借閱中</span>
														</td>
														...
														<td>
															<form method="post" action="return.php">
																...
																<input type="hidden" name="lend" value="<?php echo $record[2]; ?>">
																<input type="hidden" name="borrow" value="<?php echo $record[3]; ?>">
																<input type="hidden" name="bookname" value="<?php echo $record[0]; ?>">
																<input type="hidden" name="trade_id" value="<?php echo $record[5]; ?>">
																<button name="method" value="<?php echo $method ?>" class="btn btn-primary btn-learn" onclick="javascript:return ret();">
																	歸還
																</button>

															</form>
															<!-- <p><a href="#" class="btn btn-primary btn-learn">歸還</a></p> -->
														</td>
													</tr>
													<tr class="spacer"></tr>
										<?php
