			...
			<div id="colorlib-counter" class="colorlib-counters" style="background-image: url(images/cover_bg_1.jpg);opacity: 0.8;" data-stellar-background-ratio="0.5">
				<div style="padding: 160px 0px 160px;">
					...
					<div class="colorlib-narrow-content">
						...
						<?php
						session_start();
						$sql2 = "SELECT AVG(comment.comment_score) FROM comment WHERE comment.comment_name='$_SESSION[name]'";
...
?>
							<div class="col-md-4 text-center animate-box">
								...
								<span class="colorlib-counter js-counter" data-from="0" data-to=<?php echo $record2[0] ?> data-speed="3000" data-refresh-interval="50"></span>
							...
							<div class="col-md-4 text-center animate-box">
								...
								<span class="colorlib-counter js-counter" data-from="0" data-to="3.4" data-speed="5000" data-refresh-interval="50"></span>
							...
							<div class="col-md-4 text-center animate-box">
								...
								?>
										...
										<span class="colorlib-counter js-counter" data-from="0" data-to=<?php echo $record[1] ?> data-speed="5000" data-refresh-interval="50"></span>
