...
if (isset($_POST["method"])){
 ...
 if($method=='customer_service')
	...
	$sql="insert into comment (comment_id,trade_lend,comment_write,comment_book,comment_score,comment_content,comment_times) values ('','$commentname','$commentwrite','$commentbook','$score','$commentcontent','1')";
...
if (isset($_POST["method1"])){
	...
	if($method1 =="report")
	   ...
	   {
		  echo "666";
	   $sql="insert into report (report_id,report_reason,report_content,report_name,report_write,report_bookname) values ('','$reportreason','$reportcontent','$reportname','$reportwrite','$reportbookname')";
